...
Alternatives: push a tag yourself (`git tag -a 0.9.2 -m "apikeyrotator 0.9.2" && git push
origin 0.9.2` - CI runs on tags too, and the tag must match the package version), or run
